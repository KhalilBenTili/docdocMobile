...
// notice that we provide a plain text alternative as well in the send method
    ...
    public boolean ajoutReclamation1(Reclamation p){
        String url = Statics.BASE_URL+"/addReclamationMl?motif="+p.getMotif()+"&description="+p.getDescription()+"&user_id="+p.getUser_id() ;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
