 ...
 * @author user
 */
public class ModifierConsultation extends Form{
    Form current;
    ...
    public ModifierConsultation(Consultation c, User user)
    {  
       getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e->{ new  ListeConsultation(user).show();});
      dateTimePicker.setType(Display.PICKER_TYPE_DATE_AND_TIME);
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {  
                if(dateTimePicker.getText().contains("/"))
                {
        ...
        if(cs.edit(c))
        {
            Dialog.show("Success","Consultation modifiée avec succes",new Command("OK"));
